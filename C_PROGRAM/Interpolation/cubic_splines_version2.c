...
main()
{
    int m,n,i,j,k;
    float func(float);
    float x[100],y[100],q[100],v[100],w[100],h[100],a[100][100],u,X[100],sum,x1,F[100],f1,f[100],g1,error, temp;
    FILE*fp1=NULL;
    FILE*fp2=NULL;
    fp1 = fopen("cubicsplineknown.txt","w");
    fp2 = fopen("knowntab.txt","w"        );
    //fp3 = fopen("input_data.txt", "w")     ; 
